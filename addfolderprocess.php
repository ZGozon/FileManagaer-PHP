  <?php
        ...
        if (isset($_POST['newfold'])){
        
        $file_to_write = $_POST['newfold'];
        $path = FM_ROOT_PATH;
        if (FM_PATH != '') {
         $path .= '/' . FM_PATH;
        }
